    ...
    <div className="mb-64 p-6 sm:p-12">
      ...
      <div className="mx-auto w-full max-w-xl">
        <div className="grid gap-2">
          ...
          <p className="text-gray-500">Update the form below to edit the recipe.</p>
        </div>
        ...
        <Form method="post" className="mt-4 md:mt-8">
          ...
          <div className="mt-4 grid gap-1.5 md:mt-8">
            ...
            <Input
              defaultValue={data.recipe.servings}
              type="number"
              name="servings"
              id="servings"
            />
          ...
          <div className="mt-6 flex items-center gap-6 md:mt-10">
            ...
            <Link to={`/recipes/${data.recipe.id}`}>Cancel</Link>
          </div>
        </Form>
      </div>
    </div>
